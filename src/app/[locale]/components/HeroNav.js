...
export default function HeroNav() {
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex justify-center w-full py-3 items-center">
                <div className="px-4 grid grid-cols-6 md:grid-cols-12">
                    ...
                    <div className="hidden lg:inline-block lg:col-span-12 lg:mt-6 font-serif cursor-pointer">
            ...
            {isMobileMenuShow && 
                <div className="relative text-[14px] font-[Roboto] font-medium text-gray-800">
                    <ul className="absolute bg-gray-100 z-20 w-full md:hidden">
                        ...
                        <li className="px-6 py-2 hover:bg-[#33373d] hover:text-gray-100 transition"><Link href="/pages/residences">{t('residences')}</Link></li>
